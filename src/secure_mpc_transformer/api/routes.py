...
if BaseModel != object:
    class InferenceRequest(BaseModel):
        ...
        max_length: Optional[int] = Field(default=512, ge=1, le=2048, description="Maximum sequence length")
        ...
        protocol_config: Optional[Dict[str, Any]] = Field(default=None, description="MPC protocol configuration")
    ...
    def _setup_routes(self):
        ...
        async def predict(request: InferenceRequest):
            ...
            try:
                ...
                from ..services.inference_service import InferenceRequest as ServiceRequest
...
class SecurityRouter:
    ...
    def _setup_routes(self):
        ...
        async def get_security_events(hours: int = 24, risk_level: Optional[str] = None):
            """Get security events."""
            try:
                if not (1 <= hours <= 168):
                    raise HTTPException(status_code=400, detail="Hours must be between 1 and 168")
