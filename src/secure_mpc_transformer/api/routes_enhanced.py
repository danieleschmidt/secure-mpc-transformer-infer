...
class InferenceRequest(BaseModel):
    ...
    max_length: int | None = Field(default=512, description="Maximum sequence length")
    options: dict[str, Any] | None = Field(default_factory=dict, description="Additional options")
...
class ModelRequest(BaseModel):
    ...
    config: dict[str, Any] | None = Field(default_factory=dict, description="Model configuration")
