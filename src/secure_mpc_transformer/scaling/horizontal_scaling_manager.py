...
class PredictiveScaler:
    ...
    async def _estimate_cycle_length(self, data: List[float]) -> Optional[int]:
...
class HorizontalScalingManager:
    ...
    async def _evaluate_single_rule(self, rule: ScalingRule, metrics: ScalingMetrics) -> Optional[Dict[str, Any]]:
