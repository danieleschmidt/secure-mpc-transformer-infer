...
class QuantumPerformanceMonitor:
    ...
    def start_quantum_session(self, session_id: str, metadata: dict[str, Any] | None = None):
...
class TimingContextManager:
    ...
    def __init__(self, metrics_collector: MetricsCollector, metric_name: str, labels: dict[str, str] | None = None):
        self.metrics = metrics_collector
