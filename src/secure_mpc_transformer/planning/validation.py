...
from .quantum_planner import QuantumTaskConfig, Task, TaskType
...
class QuantumStateValidator:
    ...
    def validate_quantum_evolution(self,
                                 ...
                                 evolution_matrix: np.ndarray | None = None) -> ValidationResult:
        """
    ...
    def _is_unitary(self, matrix: np.ndarray, tolerance: float | None = None) -> bool:
...
class TaskDependencyValidator:
    ...
    def _find_dependency_cycle(self, tasks: list[Task]) -> list[str] | None:
        ...
        def dfs_visit(task_id: str) -> list[str] | None:
...
class ResourceValidator:
    ...
    def __init__(self, available_resources: dict[str, float] | None = None):
...
class QuantumPlanningValidator:
    ...
    def validate_complete_plan(self,
                             ...
                             config: QuantumTaskConfig | None = None) -> ValidationResult:
        """
    ...
    def _validate_config(self, config: QuantumTaskConfig | None) -> ValidationResult:
