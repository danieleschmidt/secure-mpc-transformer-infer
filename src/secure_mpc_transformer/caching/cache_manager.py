...
class CacheManager:
    ...
    def __init__(self, config: Optional[CacheConfig] = None):
        ...
        # Cache layers
        self.l1_cache: Optional[L1TensorCache] = None
        self.l2_cache: Optional[L2ComponentCache] = None  
    ...
    def put(self, key: str, value: Any, namespace: str = "default", 
            ttl: Optional[int] = None, cache_levels: Optional[List[CacheLevel]] = None):
    ...
    def warm_cache(self, key_value_pairs: List[Tuple[str, Any]], 
                   namespace: str = "default", priority_levels: Optional[List[CacheLevel]] = None):
    ...
    def clear_cache(self, namespace: Optional[str] = None, cache_levels: Optional[List[CacheLevel]] = None):
