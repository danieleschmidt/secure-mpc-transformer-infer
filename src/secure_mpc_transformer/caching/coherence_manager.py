...
class CacheCoherenceManager:
    ...
    def on_cache_read(self, key: str, cache_level: str = "l1") -> Any | None:
    ...
    def _handle_mesi_read(self, key: str, metadata: CacheEntryMetadata, cache_level: str) -> Any | None:
    ...
    def _get_from_cache_level(self, key: str, cache_level: str) -> Any | None:
    ...
    def _fetch_from_remote(self, key: str) -> Any | None:
