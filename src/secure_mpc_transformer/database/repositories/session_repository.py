...
from ..models import ComputationSession, SessionStatus, ProtocolType
...
class SessionRepository(BaseRepository[ComputationSession]):
    ...
    async def get_by_status(self, status: SessionStatus, limit: Optional[int] = None) -> List[ComputationSession]:
    ...
    async def get_by_protocol(self, protocol_type: ProtocolType, limit: Optional[int] = None) -> List[ComputationSession]:
    ...
    async def get_recent_sessions(self, hours: int = 24, limit: Optional[int] = None) -> List[ComputationSession]:
    ...
    async def get_failed_sessions(self, limit: Optional[int] = 50) -> List[ComputationSession]:
