...
class BaseRepository(ABC, Generic[T]):
    ...
    async def _get_by_id_postgresql(self, record_id: str) -> Optional[T]:
    ...
    async def _update_postgresql(self, data: Dict[str, Any]) -> None:
        ...
        values = [self._serialize_json_field(data[col]) for col in data.keys()]
    ...
    async def _list_all_postgresql(self, limit: Optional[int], offset: int) -> List[T]:
    ...
    async def _get_by_id_mongodb(self, record_id: str) -> Optional[T]:
    ...
    async def _list_all_mongodb(self, limit: Optional[int], offset: int) -> List[T]:
    ...
    async def _get_by_id_sqlite(self, record_id: str) -> Optional[T]:
    ...
    async def _list_all_sqlite(self, limit: Optional[int], offset: int) -> List[T]:
    ...
    async def _get_by_id_redis(self, record_id: str) -> Optional[T]:
    ...
    async def _list_all_redis(self, limit: Optional[int], offset: int) -> List[T]:
