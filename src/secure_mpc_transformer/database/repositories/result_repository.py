...
class ResultRepository(BaseRepository[InferenceResult]):
    ...
    async def get_operation_breakdown(self, session_id: str | None = None,
                                    hours: int | None = 24) -> dict[str, Any]:
    ...
    async def get_timing_breakdown(self, session_id: str | None = None,
                                 hours: int | None = 24) -> dict[str, Any]:
