...
class SecureTransformerLayer(nn.Module):
    ...
    def forward(self, hidden_states: SecureValue, attention_mask: torch.Tensor | None = None) -> SecureValue:
...
class SecureTransformer(nn.Module):
    ...
    def forward(self, input_ids: torch.Tensor, attention_mask: torch.Tensor | None = None) -> SecureValue:
