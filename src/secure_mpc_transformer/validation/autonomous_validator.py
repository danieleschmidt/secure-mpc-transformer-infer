...
class AutonomousValidator:
    ...
    async def validate_input(self, data: Any, context: Optional[Dict[str, Any]] = None) -> ValidationResult:
        """
    ...
    async def _validate_number(self, data: Union[int, float], context: Dict[str, Any]) -> ValidationResult:
