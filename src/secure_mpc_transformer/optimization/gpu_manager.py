...
class CUDAStreamManager:
    ...
    def synchronize_all_streams(self, device_id: int | None = None):
...
class GPUMemoryManager:
    ...
    def __init__(self, enable_memory_pool: bool = True, stream_config: StreamConfig | None = None):
    ...
    def get_memory_stats(self, device_id: int | None = None) -> dict[int, GPUMemoryStats]:
    ...
    def optimize_memory_usage(self, device_id: int | None = None):
