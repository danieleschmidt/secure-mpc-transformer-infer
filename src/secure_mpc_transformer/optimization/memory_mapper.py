...
class MemoryMappedModelLoader:
    ...
    def __init__(self, config: MemoryMapConfig | None = None):
    ...
    def load_model(self, file_path: str, preload_layers: list[str] | None = None,
    ...
    def _load_model_internal(self, file_path: str, device: torch.device | None) -> dict[str, MemoryMappedTensor]:
    ...
    def _load_model_fallback(self, file_path: str, device: torch.device | None) -> dict[str, MemoryMappedTensor]:
    ...
    def prefetch_model(self, file_path: str, layer_names: list[str] | None = None):
    ...
    @contextmanager
    def temporary_model_loading(self, file_path: str, device: torch.device | None = None):
