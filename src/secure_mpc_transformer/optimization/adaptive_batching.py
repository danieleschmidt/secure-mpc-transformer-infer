...
class AdaptiveBatchManager:
    ...
    def __init__(self, config: BatchingConfig | None = None, constraints: ResourceConstraints | None = None):
    ...
    def get_next_batch_size(self, current_workload_size: int | None = None) -> int:
