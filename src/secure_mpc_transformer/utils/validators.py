...
class InputValidator:
    ...
    def _validate_max_length(self, max_length: int | None):
    ...
    def validate_tensor_input(self, tensor: torch.Tensor, expected_shape: tuple | None = None) -> bool:
