...
class SecurityHelper:
    ...
    @staticmethod
    def generate_commitment(value: torch.Tensor, nonce: Optional[bytes] = None) -> Tuple[str, bytes]:
...
class ConfigHelper:
    ...
    @staticmethod
    def save_config_to_file(config: Dict[str, Any], config_path: Union[str, Path]):
