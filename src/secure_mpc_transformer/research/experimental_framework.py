...
class ResearchExperimentRunner:
    ...
    async def run_experiment(self, 
                           ...
                           parameter_grids: Optional[Dict[str, List[Any]]] = None) -> Dict[str, Any]:
        """
    ...
    def _generate_experimental_conditions(self,
                                        algorithms: Dict[str, Callable],
                                        datasets: List[Dict[str, Any]],
                                        parameter_grids: Optional[Dict[str, List[Any]]]) -> List[Dict[str, Any]]:
    ...
    async def _create_publication_figures(self, df: pd.DataFrame, output_dir: Path) -> None:
        ...
        if len(self.config.dependent_variables) >= 1:
            ...
            if main_metric in df.columns:
                ...
                for i, (bar, mean_val) in enumerate(zip(bars, algorithm_means['mean'])):
...
class ComparativeStudyFramework:
    ...
    async def run_comparative_study(self,
        ...
        experiment_config = ExperimentConfig(
            ...
            description=f"Comparative study between baseline and novel algorithms",
    ...
    def _find_best_baseline(self, algorithm_performance: Dict[str, Any]) -> Optional[str]:
