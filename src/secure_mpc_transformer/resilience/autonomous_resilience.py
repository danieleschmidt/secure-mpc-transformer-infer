...
class FailureRecord:
    ...
    resolved: bool = False
    resolution_strategy: RecoveryStrategy | None = None
...
class AutonomousResilienceManager:
    ...
    async def _retry_with_exponential_backoff(self, retry_func: Callable | None,
                                            failure_record: FailureRecord) -> Any:
    ...
    async def _retry_with_linear_backoff(self, retry_func: Callable | None,
                                       failure_record: FailureRecord) -> Any:
...
def resilient_execution(component_name: str, resilience_manager: AutonomousResilienceManager,
                       retry_function: Callable | None = None,
