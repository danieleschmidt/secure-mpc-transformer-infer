...
class SecretsManager:
    ...
    def set_secret(self, name: str, value: str, secret_type: SecretType,
                   expires_in: float | None = None, tags: list[str] = None) -> bool:
    ...
    def _validate_api_key(self, value: str) -> tuple[bool, str | None]:
    ...
    def _validate_password(self, value: str) -> tuple[bool, str | None]:
    ...
    def _validate_jwt_secret(self, value: str) -> tuple[bool, str | None]:
        """Validate JWT secret."""
        if len(value) < 32:
    ...
    def _validate_encryption_key(self, value: str) -> tuple[bool, str | None]:
